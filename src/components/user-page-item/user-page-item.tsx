    ...
    <div className="user">
      ...
      </div>
      {
        ...
        <div className="user__preorder-list">
          <h3 className="title title--3 preorder-table__title">Your pre-ordered list</h3>
            ...
            {user.preOrder.map((item) => {
              ...
              return (
                <tr className="preorder-table__item" key={item.id}>
                  ...
                  <td className="preorder-table__change-buttons-wrapper">
                    <button
        ...
        <div className="preorder-table-wrapper">
          <div className="preorder-table" style={{gridTemplateColumns: isMobile ? `repeat(${user.preOrder.length + 1}, 1fr)` : 'repeat(8, minmax(80px, 1fr))'}}>
            <div className="preorder-table__head">
              ...
              <div className="preorder-table__cell preorder-table__cell--head">Remove</div>
            </div>
            {user.preOrder.map((item) => {
              const handleRemove = () => {
                dispatch(removeItemFromPreOrder({ user: user, item: item }));
